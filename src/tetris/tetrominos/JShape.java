...
public class JShape extends SimpleTetromino {

    
    public JShape(CellPool cellPool) {
        super();
    ...
    public boolean moveDown(double len) {
        if (tetrominoCells[1].canMoveDown(len) && tetrominoCells[2].canMoveDown(len) && tetrominoCells[3].canMoveDown(len)) {
